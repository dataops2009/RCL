# Take data from the OCR import class

# Store this data into a table

# Update the TeamRanking, PlayerRanking - Forgot how this works again...

# a

# Need to send notifications to the players so they accept when they are added to a team
...
class Tournament:
    ...
    def remove_losing_team_from_top_8(self, match_results):
        for team1, team2, _, _, winner, _ in match_results:
            ...
            self.top_8_teams = [team for team in self.top_8_teams if team != loser]

    def run_tournament_phase_prefinal(self, team_list):
        self.initialise_team_rankings(team_list)
    ...
    def run_tournament_phase_final(self, top_8_teams):
        ...
        self.update_team_rankings(match_results)
        league_table = self.print_league_table()
        self.winner = league_table[0]['team']

       
        return league_table, match_results

    def transition_to_final(self):
        return self.select_top_8_teams()
